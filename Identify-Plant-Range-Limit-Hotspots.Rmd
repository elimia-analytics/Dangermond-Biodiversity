...
latitudinal_limit_r <- terra::rast("~/Library/CloudStorage/Dropbox/elimia/projects/PCI-biogeography/deliverables/Activity 2 - Data Synthesis/code/dangermond-occurrence-data/plant_range_limit_rasters/Abies amabilis_southern_probability.tif") %>%
  terra::crop(d_bbox)
#### California
...
edge_r <- terra::rast("~/Library/CloudStorage/Dropbox/elimia/projects/PCI-biogeography/deliverables/Activity 2 - Data Synthesis/code/dangermond-occurrence-data/plant_range_limit_rasters/Abies amabilis_southern_edge_limit.tif") %>%
  terra::crop(d_bbox)
#### California
