...
driver <- RSelenium::rsDriver(browser = "firefox", port = 6000L)
### Say 'I'm a client'
remote_driver <- driver[["client"]]
### Send website address to the browser
calflora_dangermond_url <- "https://www.calflora.org/entry/observ.html#srch=t&cols=0,47,46,3,13,38,1,59,33&lpom=d&chk=t&inbp=t&bgid=psd32678&y=34.5046&x=-120.4524&z=11&cch=t&cnabh=t&inat=r"
...
calflora_occurrences_dangermond_clean <- calflora_occurrences_dangermond %>% 
  dplyr::mutate(key = ID, scientificName = Plant, longitude = Longitude, latitude = Latitude, coordinateUncertaintyInMeters = `Error Radius (m)`, eventDate = Date, year = substr(eventDate, 1, 4), source = "CalFlora", dataset = Source, URL = `Detail URL`) %>% 
...
# Integrate datasets
occurrences_dangermond <- list(calflora_occurrences_dangermond_clean,
